    ...
    <section className="relative min-h-[400px] md:min-h-[500px] flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-20 text-center text-white px-4 py-20 md:py-32">
        ...
        <a
          ...
          className="inline-block bg-[#464f7f] hover:bg-[#2e3450] text-white font-semibold px-10 py-4 rounded-md transition-all duration-300 shadow-lg hover:shadow-xl transform hover:scale-105 text-base md:text-lg cursor-pointer"
        >
          LEARN MORE
        </a>
      </div>
