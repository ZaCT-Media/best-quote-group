        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-x-16 gap-y-10 mb-12">
          ...
          <div className="md:col-span-2">
            ...
            <p className="text-sm text-gray-600 mb-5 leading-relaxed">
              Have questions about commercial or domestic finance? Our expert team is here to help.
            </p>
            <div className="space-y-4">
              <div className="flex items-center gap-3">
                <svg className="w-5 h-5 text-[#1e3f6a] flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                </svg>
                <a href={`tel:${contactData.phone}`} className="text-gray-600 hover:text-[#1e3f6a] transition">
                  {contactData.phone}
                </a>
              </div>
              <div className="flex items-center gap-3">
                <svg className="w-5 h-5 text-[#1e3f6a] flex-shrink-0" fill="currentColor" viewBox="0 0 24 24">
                ...
                <a href={`https://wa.me/${contactData.whatsapp}`} target="_blank" rel="noopener noreferrer" className="text-gray-600 hover:text-[#1e3f6a] transition">
                  WhatsApp Us
                </a>
              </div>
              <div className="flex items-center gap-3">
                ...
                <a href={`mailto:${contactData.email}`} className="text-gray-600 hover:text-[#1e3f6a] transition">
                  {contactData.email}
                </a>
              </div>
            </div>
