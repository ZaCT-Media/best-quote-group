        ...
        <section className="py-20 bg-[#1e3f6a]">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <div className="bg-white rounded-lg p-12 shadow-lg">
              ...
              {/* Title */}
              <h1 className="text-4xl font-bold text-[#1e3f6a] mb-4">
                {title}
              </h1>
              ...
              <div className="border-t border-gray-200 pt-8 mt-8">
                ...
                <div className="space-y-4">
                  <a
                    ...
                    className="inline-flex items-center justify-center space-x-2 text-[#1e3f6a] hover:text-[#1e3f6a] transition cursor-pointer"
                  >
                ...
                <div className="mt-8">
                  <Link
                    href="/#services"
                    className="inline-block bg-[#1e3f6a] hover:bg-[#1e3f6a] text-white font-semibold px-8 py-3 rounded-lg transition-colors duration-300 cursor-pointer"
                  >
                    Return to Services
                  </Link>
                </div>
